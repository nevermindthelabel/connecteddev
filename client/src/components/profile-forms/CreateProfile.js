...
const CreateProfile = ({ createOrUpdateProfile, history }) => {
  ...
  const [displaySocialInputs, renderSocialInputs] = useState(false);
    ...
    <Fragment>
      ...
      <form className="form" onSubmit={event => onSubmit(event)}>
        ...
        <div className="form-group">
          ...
          <small className="form-text" value={bio} onChange={event => onChange(event)} >Tell us a little about yourself</small>
        </div>

        <div className="my-2">
          <button type="button" className="btn btn-light" onClick={() => renderSocialInputs(!displaySocialInputs)}>
